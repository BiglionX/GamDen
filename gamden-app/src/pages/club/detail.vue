    ...
    <view class="detail-header">
      <view class="detail-header__top">
        ...
        <view v-if="clubDetail" class="detail-header__vitality" @tap="showDetail">
          <text class="vitality-icon">{{ vitalityConfig.icon }}</text>
          <text class="vitality-value">{{ clubDetail.vitality }}</text>
        </view>
      </view>
    ...
    <u-overlay :show="showDetailModal" @tap="hideDetail">
      <view class="detail-modal" @tap.stop>
        ...
        <view class="detail-modal__header">
          <view class="detail-modal__icon">{{ currentClub.icon }}</view>
          <view class="detail-modal__title-block">
            <text class="detail-modal__title">{{ currentClub.name }}</text>
            <text class="detail-modal__type">{{ typeConfig.icon }} {{ typeConfig.name }}俱乐部</text>
          </view>
          <view class="detail-modal__close" @tap="hideDetail">✕</view>
        </view>
          ...
          <view class="vitality-card">
            <view class="vitality-card__top">
              <view class="vitality-card__level">
                <text class="vitality-card__icon">{{ vitalityConfig.icon }}</text>
                <text class="vitality-card__name">{{ vitalityConfig.name }}</text>
              </view>
              <text class="vitality-card__value">{{ clubDetail.vitality }}</text>
            </view>
        ...
        <view v-if="clubDetail" class="detail-modal__stats">
          <view class="stat-item">
            <text class="stat-item__value">{{ clubDetail.member_count }}</text>
            <text class="stat-item__label">成员</text>
          </view>
          <view class="stat-item">
            <text class="stat-item__value">{{ clubDetail.post_count }}</text>
            <text class="stat-item__label">帖子</text>
          </view>
          <view class="stat-item">
            <text class="stat-item__value">{{ clubDetail.endorsement_count || 0 }}</text>
            <text class="stat-item__label">联署</text>
          </view>
        </view>
        ...
        <view v-if="clubDetail" class="detail-modal__info">
          ...
          <view class="info-row" v-if="clubDetail.game_name">
            <text class="info-row__label">关联游戏</text>
            <text class="info-row__value">{{ clubDetail.game_name }}</text>
          </view>
          <view class="info-row" v-if="clubDetail.tags && clubDetail.tags.length > 0">
            <text class="info-row__label">标签</text>
          ...
          <view class="info-row">
            ...
            <text class="info-row__value">{{ new Date(clubDetail.created_at).toLocaleDateString() }}</text>
          </view>
        </view>
