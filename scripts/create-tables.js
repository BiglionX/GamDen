// 直接通过 Node.js 连接 Neon 并创建所有表
// 使用方法：node scripts/create-tables.js
...
async function createAllTables() {
  ...
  try {
    ...
    // ===== 添加外键约束 =====
    try {
      await client.query(`ALTER TABLE users ADD CONSTRAINT fk_users_invited_by FOREIGN KEY (invited_by) REFERENCES users(id) ON DELETE SET NULL;`);
    } catch(e) { /* 已存在则忽略 */ }
    try {
      await client.query(`ALTER TABLE invite_records ADD CONSTRAINT fk_invite_records_inviter FOREIGN KEY (inviter_id) REFERENCES users(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE invite_records ADD CONSTRAINT fk_invite_records_invitee FOREIGN KEY (invitee_id) REFERENCES users(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE territory_evolution ADD CONSTRAINT fk_territory_evolution_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE clubs ADD CONSTRAINT fk_clubs_owner FOREIGN KEY (owner_id) REFERENCES users(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE club_posts ADD CONSTRAINT fk_club_posts_club FOREIGN KEY (club_id) REFERENCES clubs(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE club_posts ADD CONSTRAINT fk_club_posts_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE post_replies ADD CONSTRAINT fk_post_replies_post FOREIGN KEY (post_id) REFERENCES club_posts(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE post_replies ADD CONSTRAINT fk_post_replies_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE agent_dialogues ADD CONSTRAINT fk_agent_dialogues_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE mini_programs ADD CONSTRAINT fk_mini_programs_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE sign_in_records ADD CONSTRAINT fk_sign_in_records_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE gold_transactions ADD CONSTRAINT fk_gold_transactions_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;`);
    } catch(e) {}
    try {
      await client.query(`ALTER TABLE content_audit_logs ADD CONSTRAINT fk_content_audit_logs_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE;`);
    } catch(e) {}
    console.log('\n✅ 外键约束就绪');
